...
function OtherRankingMain(props:{img1:string,icon1:string,icon2:string,title:string,profile:string,rank:2|3,place:string}) {
  const setHopUpWindow:any = useContext(HopUpContext)
  return (
    <div className="prmoRankingContents" onClick={()=>setHopUpWindow({status:true,title:props.title,img:props.img1,profile:props.profile,place:props.place})}>
